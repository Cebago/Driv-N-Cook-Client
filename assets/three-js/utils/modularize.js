...
var files = [
	...
	{path: 'animation/CCDIKSolver.js', dependencies: [], ignoreList: ['SkinnedMesh']},
	{
		...
		dependencies: [{name: 'CCDIKSolver', path: 'animation/CCDIKSolver.js'}, {
			name: 'MMDPhysics',
...

	{
		...
		dependencies: [{name: 'BokehShader', path: 'shaders/BokehShader2.js'}, {
	...
	{path: 'exporters/DRACOExporter.js', dependencies: [], ignoreList: ['Geometry']},
	{
		...
		dependencies: [],
		ignoreList: ['AnimationClip', 'Camera', 'Geometry', 'Material', 'Mesh', 'Object3D', 'RGBFormat', 'Scenes', 'ShaderMaterial']
	},
	{
	...
	{
		path: 'lines/Line2.js',
		dependencies: [{name: 'LineSegments2', path: 'lines/LineSegments2.js'}, {
			name: 'LineGeometry',
	...
	{
		path: 'lines/LineGeometry.js',
		dependencies: [{name: 'LineSegmentsGeometry', path: 'lines/LineSegmentsGeometry.js'}],
		ignoreList: []
	},
	...
	},
	{
		...
		dependencies: [{name: 'ColladaLoader', path: 'loaders/ColladaLoader.js'}, {
			name: 'JSZip',
			path: 'libs/jszip.module.min.js'
		}],
		ignoreList: []
	},
	...
	},
	{
		...
		dependencies: [{name: 'Zlib', path: 'libs/gunzip.module.min.js'}, {name: 'Volume', path: 'misc/Volume.js'}],
		ignoreList: []
	},
	...
	},
	{
		...
		dependencies: [{name: 'chevrotain', path: 'libs/chevrotain.module.min.js'}],
		ignoreList: []
	},
...

	{
		...
		dependencies: [{name: 'ConvexBufferGeometry', path: 'geometries/ConvexGeometry.js'}],
		ignoreList: ['Matrix4']
	},
	...
	{path: 'objects/Lensflare.js', dependencies: [], ignoreList: []},
	{
		...
		dependencies: [{name: 'LightningStrike', path: 'geometries/LightningStrike.js'}],
		ignoreList: ['Material']
	},
	...
	},
	{
		...
		dependencies: [{name: 'CopyShader', path: 'shaders/CopyShader.js'}, {
			name: 'ShaderPass',
	...
	},
	{
		...
		}, {name: 'DepthLimitedBlurShader', path: 'shaders/DepthLimitedBlurShader.js'}, {
	...
	},
	{
		...
		dependencies: [{name: 'SSAARenderPass', path: 'postprocessing/SSAARenderPass.js'}],
		ignoreList: []
	},
	{
	...
	},
	{
		...
		dependencies: [{name: 'Pass', path: 'postprocessing/Pass.js'}, {
			name: 'CopyShader',
			path: 'shaders/CopyShader.js'
		}, {name: 'LuminosityHighPassShader', path: 'shaders/LuminosityHighPassShader.js'}],
		ignoreList: []
	},
	...
	{path: 'renderers/Projector.js', dependencies: [], ignoreList: []},
	{
		...
		dependencies: [{name: 'Projector', path: 'renderers/Projector.js'}, {
			name: 'RenderableFace',
	...
	{path: 'utils/SceneUtils.js', dependencies: [], ignoreList: []},
	{
		...
		dependencies: [{name: 'UnpackDepthRGBAShader', path: 'shaders/UnpackDepthRGBAShader.js'}],
		ignoreList: []
	},
