...
(function ($, window, document, undefined) {
    ...
    $.extend(Parallax.prototype, {
        speed: .2, bleed: 0, zIndex: -100, iosFix: true, androidFix: true, position: "center", refresh: function () {
...
+function (a) {
    ...
    g.DEFAULTS = {interval: !1, toughness: .25}, g.prototype.cycle = function (b) {
    ...
    a.fn.carousel = function (b) {
        return this.each(function () {
            var c = a(this), d = c.data(f), e = a.extend({}, g.DEFAULTS, c.data(), "object" == typeof b && b),
        ...
        var c, d = a(this), e = a(d.attr("data-target") || (c = d.attr("href")) && c.replace(/.*(?=#[^\s]+$)/, "")),
            g = a.extend({}, e.data(), d.data()), h = d.attr("data-slide-to");
    ...
    d.event = {
        ...
        gestures: [], current: null, previous: null, stopped: !1, startDetect: function (a, b) {
            ...
            var f = a.timeStamp - b.timeStamp, g = a.center.pageX - b.center.pageX, h = a.center.pageY - b.center.pageY,
...
kyco.easyShare = function () {
    0 < $("[data-easyshare]").length && $("[data-easyshare]").each(function (a, c) {
        var b = $(this), d = b.data("easyshare-url"),
            e = "undefined" === typeof d || "" === d ? window.location.href : d,
            f = b.find("[data-easyshare-total-count]"), g = b.find('[data-easyshare-button-count="facebook"]'),
            h = b.find('[data-easyshare-button-count="twitter"]'), k = b.find('[data-easyshare-button-count="google"]'),
            l = b.find("[data-easyshare-loader]");
        $.ajax({
            url: kyco.apiPath, type: "GET", data: {url: e}, dataType: "json", success: function (a) {
        ...
        b.find('[data-easyshare-button="facebook"]').click(function () {
            var a = ($(window).width() - 500) / 2, b = ($(window).height() - 400) / 2;
        ...
        b.find('[data-easyshare-button="twitter"]').click(function () {
            var a = $(this).data("easyshare-tweet-text") || "", b = ($(window).width() - 575) / 2,
                c = ($(window).height() - 440) / 2, a = "http://twitter.com/share?text=" + encodeURIComponent(a);
...
kyco.easyShareAddCommas = function (a) {
    var c = [], b = Math.round(a).toString().split("");
