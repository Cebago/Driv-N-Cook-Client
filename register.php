                ...
                <div class="card card-login mx-auto mt-5 p-5">
                    ...
                    if (($_SERVER["SERVER_NAME"] == "back.drivncook.fr")
                        ...
                        <div class="card-body alert alert-warning">
                            Pour vous connecter en tant que client, allez sur le lien suivant <a
                                    href="https://drivncook.fr/login.php">Connexion</a>
                        </div>
                        <?php
                        ...
                        <div class="card-body alert alert-warning">
                            Pour vous connecter en tant que client, allez sur le lien suivant <a
                                    href="https://www.drivncook.com/login.php">Connexion</a>
                        </div>
                        <?php
                    }
                    ?>
