    ...
    <div class="container">
        ...
        <div class="btn-group btn-group-toggle " data-toggle="buttons">
            <label class="btn btn-success active">
                <input type="radio" name="options" id="option1" autocomplete="off" onclick="removeFilterTruck()" checked><?php getTranslate("Tous", $tabLang, $setLanguage) ?>
            </label>
            <label class="btn btn-success">
                <input type="radio" name="options" id="option2" autocomplete="off" onclick="filterTruck()"> <?php  getTranslate("Ouvert", $tabLang, $setLanguage) ?>
            </label>
        </div>
        ...
        ?>
        <!-- truck block -->
            <div class="col-md-4 col-sm-6 truckCard" style="margin-top: 10px; display: block"  onclick="location.href='http://127.0.0.1/Driv-N-Cook-Client/truck.php?idTruck=<?php echo $truck["idTruck"]?>'">
